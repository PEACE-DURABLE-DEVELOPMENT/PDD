...
export default function HomeProjectsSlider({ projectsList, t }: HomeProjectsSliderProps) {
  ...
  return (
    <div className="relative w-full">
      ...
      <button
        onClick={() => scroll("left")}
        className="absolute left-2 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-slate-950/85 backdrop-blur-xs border border-slate-800 shadow-lg flex items-center justify-center text-yellow-400 focus:outline-none cursor-pointer sm:hidden"
      ...
      <button
        ...
        className="absolute right-2 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-slate-950/85 backdrop-blur-xs border border-slate-800 shadow-lg flex items-center justify-center text-yellow-400 focus:outline-none cursor-pointer sm:hidden"
