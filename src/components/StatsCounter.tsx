...
export default function StatsCounter({
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-blue-600 scale-x-0 group-hover:scale-x-100 transition-transform duration-350 origin-left" />
      ...
      >
        ...
        {icon && (
          <div className="w-12 h-12 rounded-2xl bg-blue-50 flex items-center justify-center text-blue-700 mb-4 group-hover:bg-blue-600 group-hover:text-slate-900 transition-colors duration-300">
            {icon}
          </div>
        )}
        ...
        <div className="text-4xl md:text-5xl font-heading font-extrabold text-slate-900 tracking-tight mb-2">
          ...
          <span className="text-blue-700 font-bold">{displaySuffix}</span>
        </div>
