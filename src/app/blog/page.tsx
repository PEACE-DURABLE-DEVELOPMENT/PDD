        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold text-slate-900 mb-6 leading-tight">
              {lang === "fr" ? (
                <>Voix d&apos;<span className="text-yellow-500 relative">Impact<span className="absolute bottom-1 left-0 right-0 h-1.5 bg-yellow-400/30 -z-10" /></span> & de Changement</>
              ) : (
                <>Voices of <span className="text-yellow-500 relative">Impact<span className="absolute bottom-1 left-0 right-0 h-1.5 bg-yellow-400/30 -z-10" /></span> & Change</>
              )}
            </h1>
